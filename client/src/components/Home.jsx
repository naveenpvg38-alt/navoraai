    ...
    <div className="min-h-screen">
      ...
      <section className="relative pt-10 sm:pt-16 pb-16 sm:pb-24 px-4 sm:px-8 max-w-7xl mx-auto">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          {/* Clean, Unique Font Hero Headline: Your Mood. Your Move. */}
          <h1 className="font-syne text-4xl sm:text-6xl lg:text-7xl font-extrabold text-white mb-6 sm:mb-8 tracking-tight leading-[1.1] animate-fade-up">
            Your <span className="text-gradient-cyan">Mood.</span>{' '}
            Your <span className="text-gradient-cyan">Move.</span>
          </h1>
